...
export function SettingsDrawer() {
  ...
  const [section, setSection] = useState<
    "appearance" | "projects" | "experience" | "accessibility"
  >("appearance");
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border)]">
          ...
          <button
            ...
            className="text-[var(--muted)] hover:text-[var(--foreground)] text-xl leading-none cursor-pointer"
          >
            ✕
          </button>
        </div>
        ...
        <div className="flex border-b border-[var(--border)] text-xs overflow-x-auto">
          {(
            ["appearance", "projects", "experience", "accessibility"] as const
          ).map((s) => (
            <button
              key={s}
          ...
          {section === "accessibility" && (
            <>
              ...
              <div>
                ...
                <p className="text-xs text-[var(--muted)] mb-3">
                  Simulate or adjust colors for color vision differences
                </p>
                <div className="space-y-2">
                  {COLORBLIND_OPTIONS.map((opt) => (
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-colors ${settings.colorBlindMode === opt.value ? "border-[var(--accent)] bg-[var(--accent)]" : "border-[var(--border)] group-hover:border-[var(--accent)]"}`}
                      >
