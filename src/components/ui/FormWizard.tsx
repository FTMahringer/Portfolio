              ...
              <div key={step.id} className="flex items-center">
                ...
                <div className="flex items-center gap-2.5 relative">
                  ...
                  <div className="hidden sm:block">
                    <div
                      className={`text-xs font-semibold leading-tight transition-colors ${active ? "text-[var(--foreground)]" : done ? "text-[var(--accent)]" : "text-[var(--muted)]"}`}
                    >
                      {step.title}
                    </div>
                  </div>
                ...
                {!isLastStep && (
                  <div
                    className={`h-px w-8 sm:w-12 mx-2 flex-shrink-0 transition-colors ${i < currentStep ? "bg-[var(--accent)]" : "bg-[var(--border)]"}`}
                  />
                )}
              </div>
            );
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-1.5">
              {steps.map((_, i) => (
                <div
                  key={i}
                  className={`rounded-full transition-all ${i === currentStep ? "w-5 h-2 bg-[var(--accent)]" : i < currentStep ? "w-2 h-2 bg-[var(--accent)]/50" : "w-2 h-2 bg-[var(--border)]"}`}
                />
              ))}
            </div>
